...
export default function RobbieFace({ emotion = 'neutral', speaking = false, size = 'large', onClick }) {
  ...
  return (
    ...
    >
      {/* Robot Head */}
      <motion.div
        className="w-full h-full rounded-[2rem] bg-gradient-to-b from-sky-400 to-sky-500 shadow-2xl relative overflow-hidden border-4 border-sky-300"
        animate={speaking ? { 
          boxShadow: ['0 25px 50px -12px rgba(56, 189, 248, 0.4)', '0 25px 50px -12px rgba(56, 189, 248, 0.7)', '0 25px 50px -12px rgba(56, 189, 248, 0.4)']
        } : {}}
